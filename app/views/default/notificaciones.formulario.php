            ...
            <table class="table table-bordered" id="dataTable4" width="100%" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a class="btn btn-sm btn-success" href="javascript:AprovarDenegar('<?= $oNominas->id ?>','2')">Aprovar</a>
                            <a class="btn btn-sm btn-danger" href="javascript:AprovarDenegar('<?= $oNominas->id ?>','3')">Denegar</a>
                        </td>
                    </tr>
                </tbody>
            </table>
