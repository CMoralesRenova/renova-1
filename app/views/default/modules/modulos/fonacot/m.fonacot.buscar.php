...
$oFonacot->ValidaNivelUsuario("fonacot");
...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/modulos/fonacot/m.fonacot.listado.php",
            beforeSend: function() {
                $("#divListado").html(
                    ...
                    if (isConfirm) {
                        swal({
                            ...
                            $.ajax({
                                ...
                                type: "POST",
                                url: "app/views/default/modules/modulos/fonacot/m.fonacot.procesa.php",
                                beforeSend: function() {
