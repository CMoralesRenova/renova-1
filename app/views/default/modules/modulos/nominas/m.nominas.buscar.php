        ...
        switch (nombre) {
            ...
            case 'AddNomina':
                $.ajax({
                    ...
                    type: "POST",
                    url: "app/views/default/modules/modulos/nominas/m.nominas.formulario.add.php",
                    beforeSend: function() {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        swal({
                            ...
                            console.log();
                            asistencia = 0;
                            if ($('input:checkbox[name=asistencia_' + id_empleado + ']:checked').val() != undefined) {
                                asistencia = 1;
                            }

                            puntualidad = 0;
                            if ($('input:checkbox[name=puntualidad_' + id_empleado + ']:checked').val() != undefined) {
                                puntualidad = 1;
                            }
                            var jsonDatos = {
                                "accion": "Solicitar",
                                ...
                                "puntualidad_": puntualidad,
                                "complemento_": $("#complemento_" + id_empleado).val(),
                                "laborados_": $("#laborados_" + id_empleado).val(),
                                "comedor_": $("#comedor_" + id_empleado).val()
                            };
            ...
            case 'Final':
                $.ajax({
                    ...
                    type: "POST",
                    url: "app/views/default/modules/modulos/nominas/m.nominas.final.formulario.php",
                    beforeSend: function() {
                        $("#divFormulario").html(
                            '<div class="container"><center><img src="app/views/default/img/loading.gif" border="0"/><br />Cargando formulario, espere un momento por favor...</center></div>'
                        );
    ...
    function DatosEmpleado() {
        $.ajax({
            ...
            success: function(datos) {
                ...
                salario_asistencia = ret[1];
                salario_puntualidad = ret[2];
                salario_productividad = ret[3];
                bono_doce = ret[5];
                complemento_sueldo = ret[4];
                salario_diario = ret[0];

                $("#asistencia_add").val(salario_asistencia);
                $("#puntualidad_add").val(salario_puntualidad);
                $("#productividad_add").val(salario_productividad);
                $("#bono_add").val(bono_doce);
                $("#complemento_add").val(complemento_sueldo);
                $("#diario_add").val(salario_diario);
                $("#asistencias_add").removeAttr("readonly");
                $("#viaje").removeAttr("readonly");
                $("#extras").removeAttr("readonly");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="modal fade " id="myModal_nominas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <input type="button" id="btnGuardar" class="btn btn-danger" name="btnGuardar" value="Crear Pre Nomina">
                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        </div>
                    </div>
                </div>
            ...
            <!-- Logout Modal-->
            <div class="modal fade " id="myModal_nominasAdd" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            <input type="button" id="btnAdd" class="btn btn-danger" name="btnAdd" value="Agregar Nomina">
                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        </div>
                    </div>
                </div>
