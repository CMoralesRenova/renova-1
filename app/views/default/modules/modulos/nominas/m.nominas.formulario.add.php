        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="ahorro_add" step="0.01"  name="ahorro" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="prestamo_add" step="0.01"  name="prestamo" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="fonacot_add" step="0.01"  name="fonacot" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="infonavit_add" step="0.01"  name="infonavit" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="otros_add" step="0.01"  name="otros" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="total_r" step="0.01"  name="total_r" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" readonly="true" id="total_p" step="0.01"  name="total_p" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
