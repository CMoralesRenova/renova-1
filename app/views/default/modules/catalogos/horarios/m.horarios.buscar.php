...
$oHorarios->ValidaNivelUsuario("horarios");
...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/catalogos/horarios/m.horarios.listado.php",
            beforeSend: function() {
                $("#divListado").html(
    ...
    function Editar(id, nombre) {
        if (nombre == "Desactivar") {
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/horarios/m.horarios.procesa.php",
                beforeSend: function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/horarios/m.horarios.formulario.php",
                beforeSend: function() {
                    $("#divFormulario").html(
